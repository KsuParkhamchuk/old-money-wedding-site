        ...
        <div className="max-w-3xl mx-auto text-left">
          ...
          <Accordion type="single" collapsible className="w-full text-left">
            <AccordionItem value="item-1">
              ...
              На нашей свадьбе мы будем рады, если вместо цветов мы вместе поможем приюту “Островок” в Речице. Приносите с собой крупы (в мешках), макароны, корм для кошек и собак (сухой или влажный), овощи и фрукты для грызунов, а также ветеринарные препараты (вакцины, капли от блох, таблетки от глистов). Все вещи мы передадим в приют. Узнать больше: Instagram{' '}
                <a
